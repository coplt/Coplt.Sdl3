...
namespace Coplt.Sdl3
{
    public static unsafe partial class SDL
    {
        ...
        public static extern bool8 SetClipboardText([NativeTypeName("const char *")] byte* text);
        ...
        [return: NativeTypeName("_Bool")]
        public static extern bool8 SetPrimarySelectionText([NativeTypeName("const char *")] byte* text);
        ...
        [return: NativeTypeName("_Bool")]
        public static extern bool8 HasClipboardData([NativeTypeName("const char *")] byte* mime_type);
